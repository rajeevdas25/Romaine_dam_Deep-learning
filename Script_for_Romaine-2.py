...
"""
##=========Used to try out different ideas============

#totaldisplacementY = np.zeros(7, dtype=np.float)
#coordinatesY = np.zeros(7, dtype=np.float)


#Axial strains and deviatoric stresses in two vectors for the curve point

#axialepsilonsLow = []
#deviatoricstressesLow = []

#e1=0
#q1=0

#axialepsilonsLow.append(e1)
#deviatoricstressesLow.append(q1)
...
##+++++++++Experimental Data for Comparison+++++++++++ 
 ...
 plt.xlabel('V Displacement in m')
...
#plt.grid(True)
## plt.savefig("load_displ_curve.png")
#if filename: 
